...
INSERT INTO movies (title, year, show_time) VALUES ('Infinity War', 2019, '00:00');
UPDATE movies SET show_time = '19.15' WHERE id = 16;

DELETE FROM movies WHERE title = 'Batman Begins';
DELETE FROM movies WHERE id IN (15, 17);
DELETE FROM people WHERE name = 'Jordan Davidson';
SELECT name FROM people;
SELECT name FROM people WHERE name = 'Lidia Stopinska-Cherek';
SELECT * FROM movies;
